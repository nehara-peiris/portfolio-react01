        ...
        <>
            ...
            >
                <div className="mx-auto max-w-6xl px-4 sm:px-6">
                    <div className="mt-3 flex items-center justify-between rounded-2xl border border-gray-200/70 bg-white/60 px-3 py-2.5 backdrop-blur supports-[backdrop-filter]:bg-white/60 dark:border-gray-800/70 dark:bg-gray-900/50">
                        {/* Left: Brand */}
                        <a
                            href="#"
                            className="rounded-lg px-2 text-base font-semibold tracking-wide hover:opacity-90 focus:outline-none focus-visible:ring-2 focus-visible:ring-blue-500/50 sm:text-lg"
                            aria-label="Home"
                        >
                            Nehara.dev
                        </a>
                        ...
                        <ul className="hidden md:flex items-center gap-1 rounded-full border border-gray-200/60 bg-white/70 px-1.5 py-1.5 dark:border-gray-800/60 dark:bg-gray-900/60">
                            {LINKS.map((l) => (
                                <li key={l.href}>
                                    <a
                                        href={l.href}
                                        className="group relative block rounded-full px-3.5 py-1.5 text-sm text-gray-700 transition hover:text-blue-600 focus:outline-none focus-visible:ring-2 focus-visible:ring-blue-500/40 dark:text-gray-300 dark:hover:text-blue-400"
                                    >
                                        <span>{l.label}</span>
                                ...
                                {LINKS.map((l) => (
                                    <li key={l.href}>
                                        <a
                                            ...
                                            className="block rounded-xl px-3.5 py-2 text-[15px] text-gray-800 transition hover:bg-gray-100 hover:text-blue-600 focus:outline-none focus-visible:ring-2 focus-visible:ring-blue-500/40 dark:text-gray-200 dark:hover:bg-white/5 dark:hover:text-blue-400"
                                        >
                                            {l.label}
                                        </a>
                                    </li>
